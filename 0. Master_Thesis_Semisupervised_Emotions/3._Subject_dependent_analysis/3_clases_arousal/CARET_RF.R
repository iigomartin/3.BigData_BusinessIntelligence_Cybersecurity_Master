...
set.seed(1)
dataset1 <- read.csv("...1. Preprocessing\\Output\\sub1_arousal_3_clases.csv")
dataset2 <- read.csv("...1. Preprocessing\\Output\\sub2_arousal_3_clases.csv")
dataset3 <- read.csv("...1. Preprocessing\\Output\\sub3_arousal_3_clases.csv")
dataset4 <- read.csv("...1. Preprocessing\\Output\\sub4_arousal_3_clases.csv")
dataset5 <- read.csv("...1. Preprocessing\\Output\\sub5_arousal_3_clases.csv")
dataset6 <- read.csv("...1. Preprocessing\\Output\\sub6_arousal_3_clases.csv")
dataset7 <- read.csv("...1. Preprocessing\\Output\\sub7_arousal_3_clases.csv")
dataset8 <- read.csv("...1. Preprocessing\\Output\\sub8_arousal_3_clases.csv")
dataset9 <- read.csv("...1. Preprocessing\\Output\\sub9_arousal_3_clases.csv")
dataset10 <- read.csv("...1. Preprocessing\\Output\\sub10_arousal_3_clases.csv")
dataset11 <- read.csv("...1. Preprocessing\\Output\\sub11_arousal_3_clases.csv")
dataset12 <- read.csv("...1. Preprocessing\\Output\\sub12_arousal_3_clases.csv")
dataset13 <- read.csv("...1. Preprocessing\\Output\\sub13_arousal_3_clases.csv")
dataset14 <- read.csv("...1. Preprocessing\\Output\\sub14_arousal_3_clases.csv")
dataset15 <- read.csv("...1. Preprocessing\\Output\\sub15_arousal_3_clases.csv")
dataset16 <- read.csv("...1. Preprocessing\\Output\\sub16_arousal_3_clases.csv")
dataset17 <- read.csv("...1. Preprocessing\\Output\\sub17_arousal_3_clases.csv")
dataset18 <- read.csv("...1. Preprocessing\\Output\\sub18_arousal_3_clases.csv")
dataset19 <- read.csv("...1. Preprocessing\\Output\\sub19_arousal_3_clases.csv")
dataset20 <- read.csv("...1. Preprocessing\\Output\\sub20_arousal_3_clases.csv")
dataset21 <- read.csv("...1. Preprocessing\\Output\\sub21_arousal_3_clases.csv")
dataset22 <- read.csv("...1. Preprocessing\\Output\\sub22_arousal_3_clases.csv")
dataset23 <- read.csv("...1. Preprocessing\\Output\\sub23_arousal_3_clases.csv")
dataset24 <- read.csv("...1. Preprocessing\\Output\\sub24_arousal_3_clases.csv")
dataset25 <- read.csv("...1. Preprocessing\\Output\\sub25_arousal_3_clases.csv")
dataset26 <- read.csv("...1. Preprocessing\\Output\\sub26_arousal_3_clases.csv")
dataset27 <- read.csv("...1. Preprocessing\\Output\\sub27_arousal_3_clases.csv")
dataset28 <- read.csv("...1. Preprocessing\\Output\\sub28_arousal_3_clases.csv")
dataset29 <- read.csv("...1. Preprocessing\\Output\\sub29_arousal_3_clases.csv")
dataset30 <- read.csv("...1. Preprocessing\\Output\\sub30_arousal_3_clases.csv")
...
train <- transform(train, arousal = as.factor(arousal))
labeled.index <- createDataPartition(train$arousal, p = .2, list = FALSE)
train<- train[labeled.index,]
cl <- makePSOCKcluster(10)
registerDoParallel(cl)
metric <- "Accuracy"
fit.lda <- train(arousal~., data=train,method="rf",ntree=100, metric="Accuracy")
predictions <- predict(fit.lda, test)
stopCluster(cl)
data <- factor(predictions, levels = c('1', '2','3'))
reference <- factor(test$arousal, levels = c('1', '2','3'))
